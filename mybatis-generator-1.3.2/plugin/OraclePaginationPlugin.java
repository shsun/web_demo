package com.youdo.support.mybatis.plugin;
...
public class OraclePaginationPlugin extends PluginAdapter {
	...
	private static final String FULL_PAGE_PATH = "com.tgwoo.core.dao.pojo.Page";
...
XmlElement paginationSuffixElement = new XmlElement("sql");
	...
	private void addPage(TopLevelClass topLevelClass,
		...
		field.setType(new FullyQualifiedJavaType(FULL_PAGE_PATH));
		field.setName(name);
