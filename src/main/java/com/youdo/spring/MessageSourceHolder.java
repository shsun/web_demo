...
public class MessageSourceHolder implements MessageSourceAware {
    ...
    private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(MessageSourceHolder.class);
    ...
    public void setMessageSource(MessageSource message) throws BeansException {
        ...
        logger.info("holded messageSource,displayName:" + messageSource);
    }
