...
public class ReflectUtils {
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(ReflectUtils.class);
	 ...
	 */
	public static Object inject(String classFullName, Map<String, Object> fieldNameAndValues) throws InstantiationException,
	 ...
	 * @throws IllegalAccessException
	 */
	public static Object inject(Class<?> c, Map<String, Object> fieldNameAndValues) throws InstantiationException, ClassNotFoundException,
	...
	private static void setProperty(Object target, PropertyDescriptor targetPd, Object value) throws IllegalAccessException,
	...
	private static Object convert(String value, Class<?> targetType) {
		...
		if (DateFormatUtils.isDateType(targetType)) {
			return DateFormatUtils.parse(value, targetType, "yyyyMMdd", "yyyy-MM-dd", "yyyyMMddHHmmSS", "yyyy-MM-dd HH:mm:ss", "HH:mm:ss");
		}
