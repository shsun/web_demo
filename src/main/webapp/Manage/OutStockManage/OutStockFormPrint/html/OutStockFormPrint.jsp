...
<!-- JSON数据源 -->
<script type="text/javascript" src="<%=path%>/Manage/OutStockManage/OutStockFormPrint/store/OutStockFormPrintStore.js"></script>
<script type="text/javascript" src="<%=path%>/Manage/OutStockManage/OutStockFormPrint/uijs/OutStockFormPrint.js"></script>
