...
var OutStockBoardStore = Ext
		.create(
				'Ext.data.Store',
				{
					storeId : 'OutStockBoardStore',
					...
					proxy : {
						type : 'ajax',
						url : '/WebWms/outStockBoard/list.action', // 保存
						method : 'post',
						reader : {
							type : 'json',
							root : 'rows'
