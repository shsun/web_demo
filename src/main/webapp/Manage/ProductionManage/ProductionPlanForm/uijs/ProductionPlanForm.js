...
var checktxt = function() {
    ...
    instockplanform_pk2 = rowsSelected[0].get("instockplanform_pk");
	ProductionPlanFormContentStore.load({
		params : {
			start : 0,
			limit : 20,
			instockplanform_pk2 : instockplanform_pk2
		}
	});
	wd.show();
	wd.maximize();
