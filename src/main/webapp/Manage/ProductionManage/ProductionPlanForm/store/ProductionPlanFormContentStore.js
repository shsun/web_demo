...
Ext.define('ProductionPlanFormContentModel', {
...
var ProductionPlanFormContentStore=Ext.create('Ext.data.Store', {
	storeId : 'ProductionPlanFormContentStore',
	...
	model : 'ProductionPlanFormContentModel',
	...
	proxy : {
		type : 'ajax',
	 	url: '/WebWms/productionPlanFormContent/list_instockplancontent.action', //保存
		method:'post',
		reader : {
			type :'json',
			root:'rows'
