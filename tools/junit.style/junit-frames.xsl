...
<xsl:template match="testsuites" mode="all.tests">
	...
	<head>
	    <title>Unit Test Results Of Flash Platform: <xsl:value-of select="$title"/></title>
...
<xsl:template match="testsuite" mode="class.details">
    ...
    <html>
        <head>
          <title>Unit Test Results Of Flash Platform: <xsl:value-of select="$class.name"/></title>
            <xsl:call-template name="create.stylesheet.link">
...
<xsl:template match="testsuites" mode="overview.packages">
    <html>
        <head>
            <title>Unit Test Results Of Flash Platform: Summary</title>
            <xsl:call-template name="create.stylesheet.link">
                <xsl:with-param name="package.name"/>
            </xsl:call-template>
        </head>
